...
پنل zip داخل سامانه روی نصب‌های قبلی (نصب‌کنندهٔ قدیمی + volume کد) جلو نمی‌رود. تا وقتی یک‌بار کد جدید با Docker اعمال شود، دکمهٔ نصب داخل برنامه کار نمی‌کند.
