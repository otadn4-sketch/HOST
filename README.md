...
نسخه ۱.۵.۱: آرشیو فایل و ثبت دستی ارتباطات. ارسال سنتی در پیام‌رسان‌ها خارج از سامانه انجام می‌شود؛ سامانه فقط ثبت می‌کند چه فایلی، به چه مخاطبی، در چه تاریخی، با چه هدفی، از چه کانالی و با چه یادداشتی.
