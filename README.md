...
نسخهٔ قابل‌استقرار و خودمیزبان برای شبکه ایتان. رابط فارسی/RTL حفظ شده و به API واقعی FastAPI متصل است. هیچ سرویس ابری جانبی، Gemini، Firebase، S3 یا telemetry بیرونی استفاده نمی‌شود.
...
| `tests/` | واحد، یکپارچه، پذیرش AC-01 تا AC-08 |
