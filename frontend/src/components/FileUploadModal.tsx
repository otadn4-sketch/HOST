          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
            ...
            <div className="space-y-1.5 text-[11px] text-slate-600">
              <div className={`flex items-center gap-2 ${scanStep >= 1 ? 'text-blue-700 font-semibold' : ''}`}>
                ...
                <span>۱. اعتبارسنجی نوع MIME واقعی، پسوند مجاز و محاسبه هش SHA-256</span>
              </div>
              <div className={`flex items-center gap-2 ${scanStep >= 2 ? 'text-blue-700 font-semibold' : ''}`}>
                ...
                <span>۲. پویش امضای بدافزار با موتور آنتی‌ویروس محلی ClamAV</span>
              </div>
              <div className={`flex items-center gap-2 ${scanStep >= 3 ? 'text-blue-700 font-semibold' : ''}`}>
                ...
                <span>۳. رمزنگاری و ذخیره‌سازی با شناسه تصادفی در والت خارج از وب‌روت</span>
              </div>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-1.5 text-[11px] text-slate-500">
              ...
              <span>پروتکل امنیتی: نگهداری در مخزن ایزوله</span>
            </div>
