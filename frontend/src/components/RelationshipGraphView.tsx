...
export const RelationshipGraphView: React.FC<{ enabled: boolean }> = ({ enabled }) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-[#E8D9C4] space-y-3">
      ...
      <p className="text-xs text-[#6B5344] leading-relaxed">این گراف برای محیط آفلاین و localhost طراحی شده و روی وب عمومی قرار نمی‌گیرد. پالایش فراداده PDF/Word نیز در همین فاز به‌صورت stub است.</p>
